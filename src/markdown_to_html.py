...
def markdown_to_html_node(markdown):
    ...
    for block in blocks:
        ...
        # Paragraph
            ...
            paragraph_node = HTMLNode(f"p", None, None, children)
        ...
        # Code
            ...
            code_node = HTMLNode('code', None, None, [content])
        ...
        # Unordered List
            ...
            unordered_node = HTMLNode('ul', None, None, items)
        ...
        # Ordered List
            ...
            items = text_to_list_item(text)
            ordered_node = HTMLNode('ol', None, None, items)
...
def text_to_list_item(text):
    ...
    for item in items:
        ...
        list_item = HTMLNode('li', None, None, html_nodes)
